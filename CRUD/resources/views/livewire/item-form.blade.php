<div class="flex justify-center items-center min-h-screen bg-base-200 p-6">
    <div class="card w-full max-w-4xl bg-base-100 shadow-2xl overflow-hidden">
        <div class="card-body p-0">
            ...
            <!-- Form -->
            <form wire:submit='submit' method="POST" class="space-y-8 p-12"> 
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="form-control">
                        ...
                        <input wire:model='quantity' type="number" placeholder="0" min="0" class="input input-bordered w-full h-14 text-lg @error('quantity') input-error @enderror" required />
                ...
                <div class="form-control">
                    ...
                    <div class="flex gap-8">
                        <label class="label cursor-pointer justify-start gap-4">
                            <input wire:model='is_available' type="radio" value="1" class="radio radio-primary w-6 h-6" />
                ...
                <div class="flex justify-end space-x-6 pt-8 mt-8 border-t">
                    <button type="submit" id="submit-btn" class="btn btn-primary h-14 px-8 text-lg">
                        <span id="btn-text">{{ $isEditing ? 'Update Item' : 'Create Item' }}</span>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
                        <svg id="loading-spinner" class="hidden w-6 h-6 ml-2 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
