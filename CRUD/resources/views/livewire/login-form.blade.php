...
<div class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
        ...
        <!-- Alert message - remove or modify as needed -->
        <div class="mb-4 bg-red-50 border-l-4 border-red-500 p-4 hidden">
            <div class="flex">
        ...
        <form class="space-y-4">
            ...
            <button type="button" class="w-full bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 text-white font-medium py-2.5 rounded-lg transition-all duration-300 transform hover:scale-[1.01]">
                Sign In
            </button>
        </form>
